 ...
 * 模板编译
 *
 * @see https://github.com/vuejs/vue/blob/v2.6.10/src/compiler/index.js
 * 
 * @author  Yang,junlong at 2019-07-03 15:41:56 build.
 * @version $Id$
 */
...
/* /platforms/web/compiler/modules/class.js */
...
/* /platforms/web/compiler/modules/style.js */
...
var decodeHTMLCached = cached(noop);
...
/* /platforms/web/compiler/modules/model.js */
...
/* /platforms/web/compiler/directives/text.js */
...
var fs = require('fs');
var htm = fs.readFileSync('../sfc.vue', 'utf8');
var result = parseComponent(htm, {});

var renderssss = compile(result.template.content);
